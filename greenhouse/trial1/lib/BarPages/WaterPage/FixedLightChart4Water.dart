...
class FixedLineChartWidget4Water extends StatefulWidget{
  @override
  State<FixedLineChartWidget4Water> createState() => _FixedLineChartWidget4WaterState();
}

class _FixedLineChartWidget4WaterState extends State<FixedLineChartWidget4Water> {
  ...
  Widget build(BuildContext context) {
    return Consumer<FireBringer?>(
        ...
        LineChartData(
          ...
          minY: objectIndex!.moisture.reduce(min)-10,
          maxY: objectIndex!.moisture.reduce(max)+10,
          gridData: FlGridData(
            show: true,
          ...
          lineBarsData: [
            LineChartBarData(
              spots: objectIndex?.returnFlSpots4Water(),
              isCurved: true,
